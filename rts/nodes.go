...
func AmpNodesHandler(w http.ResponseWriter, r *http.Request) {
	// vars := mux.Vars(r){{end}}
	// lang := vars["lang"]
	// site := mod.Site{}
...
func AdminNodePageHandler(w http.ResponseWriter, r *http.Request) {
	// vars := mux.Vars(r)
	// lang := vars["lang"]
	// postID := vars["post"]
	userName := GetUserName(r)
...
func AdminNodeHandler(w http.ResponseWriter, r *http.Request) {
	userName := GetUserName(r)
	if !hlp.IsEmpty(userName) {
		// r.ParseForm()
